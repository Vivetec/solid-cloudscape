...
const banFiles = require("../src/ban-files");
  ...
  invalid: [
    {
      ...
      errors: [
        {
          message:
            "Disallowed import 'src/index.ts' in favor of having smaller bundle sizes.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Disallowed import 'src/button/index.tsx'.\nUse the internal component for composition instead.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "Disallowed import 'src/icon/index.tsx'.\nUse the internal component for composition instead.",
        },
      ],
    },
    {
      ...
      errors: [
        {
          message:
            "Disallowed import 'src/internal/index.tsx'.\nUse the internal component for composition instead.",
        },
      ],
    },
  ],
